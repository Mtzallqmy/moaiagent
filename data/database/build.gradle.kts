...
dependencies { implementation(project(":core:model")); implementation(libs.androidx.room.runtime); implementation(libs.androidx.room.ktx); kapt(libs.androidx.room.compiler); implementation(libs.kotlinx.coroutines); implementation(libs.serialization.json) }
