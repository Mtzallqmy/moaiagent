...
dependencies {
    implementation(project(":core:model")); implementation(project(":core:ai")); implementation(project(":core:agent")); implementation(project(":core:permissions")); implementation(project(":core:workspace")); implementation(project(":core:runtime")); implementation(project(":core:terminal")); implementation(project(":core:git")); implementation(project(":core:browser")); implementation(project(":core:tasks")); implementation(project(":core:research")); implementation(project(":core:artifacts")); implementation(project(":core:subagents")); implementation(project(":data:database"))
